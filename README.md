...
Software für die digitale Kaffeeküche komplett in Python geschrieben.
Deutsch | English
Übersicht
...
sudo apt-get install python3-gi-cairo
    ...
    • unclutter (optional) – Lässt den Mauszeiger verschwinden. Allerdings funktioniert das mit dem neuen Raspberry Pi OS nicht mehr (Grund: Wechsel auf Wayland)
